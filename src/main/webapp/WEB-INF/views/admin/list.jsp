...
<div class="container-fluid">
    <h1 class="h3 mb-2 text-gray-800">Admini</h1>
        ...
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">
                <a href="add-edit" class="btn btn-primary btn-icon-split">
                    ...
                    <span class="text">Nowy admin</span>
                </a>
            </h6>
        </div>
        <div class="card-body">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h3>Czy na pewno chcesz usunąć admina: <span id="modalDeleteName" class="font-weight-bold"></span> ?</h3>
                <h4>Tej operacji nie można cofnąć!</h4>
            </div>
            <div class="modal-footer">
                <button class="btn btn-secondary" type="button" data-dismiss="modal">Anuluj</button>
                <a class="btn btn-danger inst-del" href="delete?adminId=">Usuń</a>
            </div>
        </div>
    </div>
</div>
